...
image=tofuctf/pie-pudding:local
container=tofuctf-pie-pudding
volume=tofuctf-pie-pudding-flag
port="${PORT:-31337}"
slug=pie-pudding
...
echo "PIE Pudding is ready: nc 127.0.0.1 $port"
