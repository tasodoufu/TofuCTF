...
image=tofuctf/canary-curry:local
container=tofuctf-canary-curry
volume=tofuctf-canary-curry-flag
port="${PORT:-31337}"
slug=canary-curry
...
echo "Canary Curry is ready: nc 127.0.0.1 $port"
